'''
This file takes the raw SeizelT2 dataset and outputs the channel that we're interested in in compressed csv files

INPUTS: SeizelT2 data set. Input the path with path_to_datset
OUTPUTS: Individual csvs, sub-XXX.csv.gz that contain EEG data and a seizure label, given they have the channels we care about
'''
